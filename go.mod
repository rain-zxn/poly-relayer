...
require (
	...
	github.com/polynetwork/bridge-common v1.111.1-plt
...
replace (
github.com/ethereum/go-ethereum => github.com/dylenfu/palette v0.0.0-20210817120114-6e0ae4f73447
github.com/polynetwork/bridge-common v1.111.1-plt => github.com/rain-zxn/bridge-common v0.0.15-plt.0.20220414140202-a002aba9ed6a
)
